...
export default class ProductForm {
  categoryUrl = '/api/rest/categories';
      ...
      <div class="product-form">
        ...
        <form data-element="productForm" class="form-grid">
            ...
            <div class="form-group form-group__part-half">
              ...
              <input required id="quantity" type="number" class="form-control" name="quantity" placeholder="${this.defaultFormData.quantity}">
            </div>
  ...
  getFormData() {
    ...
    const imageHTMLCollection = imageListContainer.querySelectorAll('.sortable-table__cell-img');

    values.images = [];
    values.id = this.productId;

    for (const image of imageHTMLCollection) {
      values.images.push({
        url: image.src,
        source: image.alt
      });
  ...
  async loadProductData(productId) {
    const url = new URL(this.productUrl, BACKEND_URL);
  ...
  async loadCategoriesList() {
    const url = new URL(this.categoryUrl, BACKEND_URL);
